...
class NoteDaoTest {
    ...
    fun insertAndGetNote() {
        val note = Note(1, "Hello", "World", currentDate, currentDate)
    ...
    fun getAllNotes() {
        val note1 = Note(1, "Hello", "World", currentDate, currentDate)
        noteDao.insertNote(note1)
        val note2 = Note(2, "Goodbye", "World", currentDate, currentDate)
    ...
    fun updateNote() {
        val note = Note(1, "Hello", "World", currentDate, currentDate)
        noteDao.insertNote(note)
        val updatedNote = Note(1, "Goodbye", "World!", currentDate, currentDate)
